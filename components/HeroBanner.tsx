...
export default function HeroBanner({ images }: { images: DbHomeBannerImage[] }) {
  ...
  if (effectiveDesktop.length === 0 && effectiveMobile.length === 0) {
    return (
      <section className="relative pt-[120px] md:pt-[130px] px-3 sm:px-4 md:px-6 lg:px-8">
  ...
  return (
    <section className="relative pt-[120px] md:pt-[130px] px-3 sm:px-4 md:px-6 lg:px-8 pb-3 md:pb-4">
